...
insert into public.collection_themes (id, name, description, palette, sort_order) values
  ('field-note', '골목 관찰 노트', '처음 쓰는 냥도감에 어울리는 따뜻한 기본 표지', 'warm', 10),
  ('sunny-window', '햇살 창가', '햇빛 아래 낮잠 자는 고양이를 닮은 기본 표지', 'green', 20),
  ('night-alley', '밤 골목 산책', '조용한 밤 산책 감성을 담은 표지', 'night', 110),
  ('sticker-drawer', '스티커 서랍', '스탬프와 배지를 가득 붙인 표지', 'playful', 120),
  ('winter-blanket', '겨울 담요', '겨울에 만난 고양이를 포근하게 보여주는 표지', 'winter', 130)
...
insert into public.season_stamps (id, name, description, season_key, starts_on, ends_on, sort_order) values
  ('spring-walk-2026', '봄 산책 냥발 도장', '봄 골목에서 만난 친구들을 기억해요.', '2026-spring', date '2026-03-01', date '2026-05-31', 10),
  ('summer-shade-2026', '여름 그늘 냥발 도장', '더운 날 그늘 아래의 만남을 남겨요.', '2026-summer', date '2026-06-01', date '2026-08-31', 20),
  ('autumn-alley-2026', '가을 골목 냥발 도장', '선선한 골목에서 마주친 순간을 모아요.', '2026-autumn', date '2026-09-01', date '2026-11-30', 30),
  ('winter-blanket-2026', '겨울 담요 냥발 도장', '겨울 냥도감에 포근한 도장을 붙여요.', '2026-winter', date '2026-12-01', date '2027-02-28', 40)
on conflict (id) do update set
  name = excluded.name,
  description = excluded.description,
